 ...
 */
function weebpal_install_tasks_alter(&$tasks, &$install_state) {
  $new_tasks = array(
 ...
 */
function extended_install_configure_form_validate($form, &$form_state) {
 ...
 */
function extended_install_configure_form_submit($form, &$form_state) {
  global $user;
...
function extended_install_configure_form($form, &$form_state, &$install_state) {
...
function extended_install_selected_profile() {
  ...
  if ($driver == 'mysql') {
    ...
    $success = extended_import_database($file_name, $prefix, $connection);
...
function extended_import_database($file_name, $prefix, $connection) {
  try {
